	...
	public function get_font_icons_def() {
		return apply_filters(
			...
			array(
				...
				'dpt-collapse-all' => '<symbol id="icon-dpt-collapse-all" viewBox="0 0 32 32"><path fill="currentColor" d="M30 15h-2V7H13V5h15a2 2 0 0 1 2 2Z"/><path fill="currentColor" d="M25 20h-2v-8H8v-2h15a2 2 0 0 1 2 2Z"/><path fill="currentColor" d="M18 27H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2M4 17v8h14.001L18 17Z"/></symbol>'
			)
		);
	}
}
